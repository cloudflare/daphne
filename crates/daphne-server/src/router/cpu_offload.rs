...
use crate::App;
use axum::{async_trait, extract::FromRequest, response::IntoResponse, routing::get};
use daphne::{error::DapAbort, InitializedReport};
use daphne_service_utils::{
    capnproto_payload::{
        CapnprotoPayloadDecode, CapnprotoPayloadDecodeExt, CapnprotoPayloadEncodeExt,
    },
...
pub(super) fn add_routes(router: super::Router<App>) -> super::Router<App> {
    router.route("/cpu_offload/initialize_reports", get(initialize_reports))
}
