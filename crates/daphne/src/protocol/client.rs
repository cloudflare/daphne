...
use crate::{
    ...
    vdaf::{prio2::prio2_shard, prio3_draft09::prio3_shard, prio3_latest::prio3_latest_shard, VdafError},
...
impl VdafConfig {
    ...
    pub(crate) fn produce_input_shares(
        ...
        match self {
            ...
            Self::Prio3Latest(prio3_config) => Ok(prio3_latest_shard(prio3_config, measurement, nonce, *task_id)?),
