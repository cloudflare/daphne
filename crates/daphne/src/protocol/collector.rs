...
use crate::{
    ...
    vdaf::{prio2::prio2_unshard, prio3_draft09::prio3_unshard, prio3_latest::prio3_latest_unshard},
    ...
    pub fn consume_encrypted_agg_shares(
        ...
        match self {
            Self::Prio3Draft09(prio3_config) => {
                prio3_unshard(prio3_config, num_measurements, agg_shares)
            }
            Self::Prio3Latest(prio3_config) => {
                prio3_latest_unshard(prio3_config, num_measurements, agg_shares )
            }
