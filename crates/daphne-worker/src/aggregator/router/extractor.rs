...
/// the type parameters.
pub struct UnauthenticatedDapRequestExtractor<B: RequestBody>(pub DapRequest<B>);
...
pub struct DapRequestExtractor<const SENDER: dap_sender::DapSender, B: RequestBody>(
    pub DapRequest<B>,
);
